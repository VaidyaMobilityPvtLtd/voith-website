...
export const whyReasons: WhyReason[] = [
  ...
  },
  {
    ...
    description:
      "Toyota, Ather, Ultraviolette, Huaxin, Keeway, Benelli, Morbidelli, XCMG, The Postcard Hotel and more. We bring global engineering and standards directly to Nepali customers.",
  },
  {
    stat: "2,000+",
    title: "People behind the promise",
    description:
      "Sales, service, plant, and field teams across all seven provinces. They are the everyday reason customers come back to VOITH.",
  },
  {
    stat: "NADA",
    title: "Category leadership",
    description:
      "From Nepal's authorised Toyota dealer to a leading electric scooter brand and a major cement plant, we lead where we operate.",
  },
  {
    stat: "All 7",
