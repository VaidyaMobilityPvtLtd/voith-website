...
export const hospitalitySector: SectorPage = {
  ...
  heroImage: "/sectors/Hospitalityhero.jpeg",
  intro:
  ...
  brands: [
    {
      ...
      image: "/brands/SasvataHero.jpg",
      logo: "/brands/sasvata_logo.png",
      description:
