...
export const milestones: Milestone[] = [
  ...
  },
  {
    ...
    description:
      "Vaidya Energy's Ather EV takes Best Stall at Nepal's premier auto show, strengthening its position as a leading electric scooter brand in Nepal.",
  },
  {
...
export const storyMilestones: StoryMilestone[] = [
  ...
  },
  {
    ...
    topic: "Women’s Rally",
    body: "Launched in 2004, the Toyota Women’s Rally is Nepal’s pioneering women-focused motorsport initiative, celebrating women’s confidence, skill, and independence. It is a powerful symbol of empowerment on the road and in life.",
  ...
  },
  {
    ...
    body: "Vaidya Energy's Ather EV took Best Stall at Nepal's premier auto show, strengthening its position as a leading electric scooter brand in Nepal.",
